...
function Completed({ navigation }) {
    ...
    const Item = ({ item, backgroundColor, textColor }) => (
        ...
        <TouchableOpacity
            onPress={() => {
                const itemArray = { id: item.id, name: item.name, barcode: item.barcode, stock: item.stock, url: item.url, completed: item.completed};
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View>
                            <Text style={[styles.buttonDetailLabel, textColor]}>Completion Date: {item.completed}</Text>
